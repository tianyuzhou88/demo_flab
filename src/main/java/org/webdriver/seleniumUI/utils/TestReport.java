...
import org.webdriver.seleniumUI.config.Config;
...
public class TestReport implements IReporter{
	...
	private void outputResult(List<ITestResult> fullResults, String path){
		...
		try {
			...
			sb.append("<div style=\"pading-top:20px\">Starting Time："
					+ this.formatDate(fullResults.get(0).getStartMillis())
					+ "</div>\n");
			sb.append("<div>Ending Time："
					+ this.formatDate(fullResults.get(fullResults.size()-1).getEndMillis())
					+ " </div>\n");
			sb.append("<div>Time&nbsp&nbsp&nbsp&nbspTake："
			...
			sb.append("<tr>\n"
					+ "<td width=\"84\"><div align=\"center\">Total TestCase</div></td>\n");
			sb.append("<td width=\"152\" align=\"center\"><div align=\"center\">PASS</div></td>\n");
			sb.append("<td width=\"125\" align=\"center\"><div align=\"center\">FAILED</div></td>\n");
			sb.append("<td width=\"96\" align=\"center\"><div align=\"center\">SKIP</div></td>\n");
			sb.append("<td width=\"91\" align=\"center\"><div align=\"center\">PASSING RATE</div></td>\n</tr>\n");
			sb.append(" <tr>\n<td><div align=\"center\">");
			...
			sb.append("<tr>\n<td colspan=7 align=\"left\" style=\"color:green;font-size:14px;font-weight:bold\">All the Test Cases</td>\n</tr>\n");
			sb.append("<tr>\n<td width=\"2%\" class=\"SEQ\">Item NO.</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">Functionality</td>\n");
			sb.append("<td width=\"20%\" class=\"case_name_td\">Test Case Name</td>\n");
			sb.append("<td width=\"43%\" colspan=2 align=\"left\">Test Result</td>\n");
			sb.append("<td width=\"20%\" class=\"case_result_beizhu_td\">Extra</td>\n");
			sb.append("<td width=\"10%\" class=\"case_time\">Time Taken</td>\n");
			sb.append("</tr>\n");
			...
			for (int i = 0; i < fullResults.size(); i++)
			{
				...
				if (!fullResults.get(i).getMethod().getDescription().isEmpty())
				{
					...
					sb.append("Assertion:：<br />\n");
					sb.append("</span><div class=\"full_info_div\"></div></td>\n");
					if (fullResults.get(i).getParameters().length>0) {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data："+fullResults.get(i).getParameters()[0]+"</td>\n");
					}
					else {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data：NONE"+"</td>\n");
					}
			...
			sb.append("<tr>\n<td colspan=7 align=\"left\" style=\"color:green;font-size:14px;font-weight:bold\">Skip Test Case</td>\n</tr>\n");
			sb.append("<td width=\"2%\" class=\"SEQ\">Item NO.</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">Functionality</td>\n");
			sb.append("<td width=\"20%\" class=\"case_name_td\">Test Case</td>\n");
			sb.append("<td width=\"43%\" colspan=2 align=\"left\">Test Result</td>\n");
			sb.append("<td width=\"20%\" class=\"case_result_beizhu_td\">Extra</td>\n");
			sb.append("<td width=\"10%\" class=\"case_time\">Time Taken</td>\n");
			sb.append("<tr>\n");
			...
			for (int j = 0; j < skipArrayList.size(); j++)
			{
				...
				if (!skipArrayList.get(j).getMethod().getDescription().isEmpty()) {
					...
					if (skipArrayList.get(j).getParameters().length>0) {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data："+skipArrayList.get(j).getParameters()[0]+"</td>\n");
					}
					else {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data：NONE"+"</td>\n");
					}
			...
			sb.append("<tr>\n<td colspan=7 align=\"left\" style=\"color:green;font-size:14px;font-weight:bold\">Passing Test Cases</td>\n</tr>\n");
			sb.append("<tr>\n<td width=\"2%\" class=\"SEQ\">Item NO.</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">Functionality</td>\n");
			sb.append("<td width=\"20%\" class=\"case_name_td\">Test Case</td>\n");
			sb.append("<td width=\"43%\" colspan=2 align=\"left\">Test Result</td>\n");
			...
			for (int i = 0; i < passArrayList.size(); i++)
			{
				...
				if (!passArrayList.get(i).getMethod().getDescription().isEmpty()) {
					...
					if (passArrayList.get(i).getParameters().length>0) {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data："+passArrayList.get(i).getParameters()[0]+"</td>\n");
					}
					else {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data：NONE"+"</td>\n");
					}
			...
			sb.append("<tr>\n<td colspan=7 align=\"left\" style=\"color:red;font-size:14px;font-weight:bold\">Failed Test Cases</td>\n</tr>\n");
			sb.append("<tr>");
			sb.append("<td width=\"2%\" class=\"SEQ\">Item NO.</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">Functionality</td>\n");
			sb.append("<td width=\"20%\" class=\"case_name_td\">Test Case</td>\n");
			...
			for (int j = 0; j < failedArrayList.size(); j++)
			{
				...
				if (!failedArrayList.get(j).getMethod().getDescription().isEmpty()) {
                 ...
                 .append("time:"+Float.toString(t)+"毫秒"+"<br />\n")*/
					...
					if (failedArrayList.get(j).getParameters().length>0) {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data："+failedArrayList.get(j).getParameters()[0]+"</td>\n");
					}
					else {
						sb.append("<td class=\"case_result_beizhu_td\">"+"Input Data：NONE"+"</td>\n");
					}
			...
			sb.append("</table>\n</div>\n");
			sb.append("</div>\n"
					+"<span style=\"font-size:14px;margin-top:5px\" >click for details</span>"
					+ "<div id=\"footer\" >TECH SUPPORT: tianyzho@cisco.com</div>");
			sb.append("</body>\n</html>\n");
